  ...
  <div class="max-w-sm mx-auto px-6">
    <div class="relative flex flex-wrap">
      <div class="w-full relative">
        ...
        <?php if(array_key_exists('validation_err', $_SESSION)) { ?>

          <ul class="bg-red-100 my-4 py-2 px-4 rounded-lg">
            <?php
              foreach(get_data_from($_SESSION, 'validation_err', []) as $err) {
            ?>
          ...
          <form class="mt-8" action="auth/register.php" method="post">
